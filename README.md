# Pegadex — Landing Page Simples

Projeto de uma landing page básica para a **Pegadex**, desenvolvida apenas com HTML5 e CSS3 sem complicações.

## 🛠️ Como o projeto foi pensado

O site foi construído do jeito mais direto e simples possível:
